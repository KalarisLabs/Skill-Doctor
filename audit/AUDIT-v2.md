...
| **~12 MB binary install footprint** | Pre-registered target vs measured | Explicitly labels ~12 MB as target ceiling, and documents actual measured release binary footprint as **2.2 MB** on Windows x64 MSVC. | **PASS** | `sd-bench/RESULTS.md:17` |
