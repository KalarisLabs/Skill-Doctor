...
% ---- orcid icon ------------------------------------------------------
\newcommand{\orcid}[1]{\href{https://orcid.org/#1}{\raisebox{-1.2pt}{\includegraphics[height=10pt]{orcid.png}}}}

\title{%
  \vspace{-1.2cm}%
  \includegraphics[width=44mm]{kalaris-logo.png}\\[16pt]%
  \bfseries Skill Doctor: Deterministic Multi-Layer Security Analysis of\\
  AI Agent Skill Files with Host-Delegated Semantic Inference%
}

\author{Sayan Chowdhury~\orcid{0009-0004-8421-0087}\\
  Kalaris Labs\\
...
\begin{lstlisting}[caption={BibTeX entries for this paper and for the software artifact.}]
@misc{chowdhury2026skilldoctor,
  title  = {Skill Doctor: Deterministic Multi-Layer Security Analysis of
            AI Agent Skill Files with Host-Delegated Semantic Inference},
  author = {Chowdhury, Sayan},
  year   = {2026},
  note   = {Describes Skill Doctor v0.1.0},
